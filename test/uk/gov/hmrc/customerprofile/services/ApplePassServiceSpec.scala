...
class ApplePassServiceSpec extends BaseSpec {
  ...
  "getApplePass" should {
    "audit and return an apple pass model with a base 64 encoded string" in {
      ...
      when(auditService.withAudit[RetrieveApplePass](any(),any())(any())(any(), any())).thenReturn(Future.successful(RetrieveApplePass(base64String)))
      ...
      when(getApplePassConnector.getApplePass(any())(any(), any())).thenReturn(Future.successful(RetrieveApplePass(base64String)))
